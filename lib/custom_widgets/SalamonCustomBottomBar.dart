...
class SalomonCustomBottomBar extends StatelessWidget {
  ...
  final List<SalomonCustomBottomBarItem> items;
...
/// A tab to display in a [SalomonCustomBottomBar]
class SalomonCustomBottomBarItem {
  /// An icon to display.
  final Widget icon;
